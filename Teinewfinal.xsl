...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        <html>
            ...
            <body>
                ...
                <p> Right click to download the source files: <a href="TeiFinal.xml">XML</a>, <a
                    href="Teinewfinal.xsl">XSLT</a>, and <a href="teifinal.css">CSS</a>.</p>
                <xsl:apply-templates/>
            </body>
        </html>
    </xsl:template>
  ...
  <xsl:template match="tei:hi">
    ...
    <xsl:template match="tei:person">
        ...
        <h3><xsl:apply-templates select="tei:persName"/></h3>
